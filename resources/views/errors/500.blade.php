...
<head>
    ...
    <style>
        ...
        @keyframes SpannerAnimation {
            ...
            50% {
                transform: translate3d(20px, 20px, 1px) rotate(360deg);
            }

            100% {
                transform: translate3d(20, 20px, 1px) rotate(360deg);
            }
        }
    </style>
</head>
...
<div class="Container">
    ...
    <h1 class="MainTitle">Có lỗi xảy ra</h1>
    <p class="Main Description">
        Máy chủ hiện đang quá tải hoặc có lỗi xảy ra - Vui lòng nhấn 'tải lại' trên trình duyệt của bạn sau một vài phút
        để thử lại
    </p>
</div>
</body>
